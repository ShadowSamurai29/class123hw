...
while(True):
  ...
  try:
    ...
    #For grayscale images, each pixel is represented by 8 bit,
    #0 means black, 255 represents white, other numbers represent different grayscale.
    image_bw = im_pil.convert('L')
    #In digital signal processing, spatial anti-aliasing is a technique 
    # for minimizing the distortion artifacts (aliasing) 
    # when representing a high-resolution image at a lower resolution.
    #  Anti-aliasing is used in digital photography, 
    ...
    # nth percentile of the given data (array elements) along the specified axis.
